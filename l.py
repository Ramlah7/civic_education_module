...
class CivicEducationApp(QMainWindow):
    ...
    def handle_chat(self):
        ...
        self.chat_display.append("<b>Gemini:</b>")
        short_reply = "".join(reply.splitlines()[:5])
        formatted_reply = markdown(short_reply)
        self.chat_display.append(f"<div style='margin: 6px 0 6px 24px; line-height: 1.5;'>{formatted_reply}</div>")
